...
#define Fix3D_Pin GPIO_PIN_5
#define Fix3D_GPIO_Port GPIOA
#define BLUETOOTH_MCU_Pin GPIO_PIN_6
#define BLUETOOTH_MCU_GPIO_Port GPIOA
#define BUZZER_Pin GPIO_PIN_7
#define BUZZER_GPIO_Port GPIOA
#define SEL_PROG_LORA_BLU_Pin GPIO_PIN_1
#define SEL_PROG_LORA_BLU_GPIO_Port GPIOB
#define SEL_PROG_MCU_FTDI_Pin GPIO_PIN_2
#define SEL_PROG_MCU_FTDI_GPIO_Port GPIOB
