...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, BUZZER_Pin|BUZZERH3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BUZZER_Pin BUZZERH3_Pin */
  GPIO_InitStruct.Pin = BUZZER_Pin|BUZZERH3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : SENSOR_IR1_Pin */
  GPIO_InitStruct.Pin = SENSOR_IR1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SENSOR_IR1_GPIO_Port, &GPIO_InitStruct);
